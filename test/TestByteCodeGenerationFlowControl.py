...
class TestFlowControlByteCodeGeneration(unittest.TestCase):
    ...
    def test_generateByteCode_will_make_code_for_if(self):
        ...
        self.assertEqual(self.byteCodeGenerator.branchIfTrue([0, 1]), byteCodes[3])
    ...
    def test_generateByteCode_will_make_code_for_if_with_statements(self):
        ...
        self.assertEqual(self.byteCodeGenerator.addRegister([0, 5, 0]),byteCodes[11])
        self.assertEqual(self.byteCodeGenerator.loadRegister([5, 7, 16]),byteCodes[12])
        self.assertEqual(self.byteCodeGenerator.storeRegister([0, 7, 16]), byteCodes[13])
        ...
        self.assertEqual(self.byteCodeGenerator.storeRegister([0, 7, 20]),byteCodes[18])
        ...
        self.assertEqual(self.byteCodeGenerator.storeRegister([0, 7, 16]),byteCodes[23])
    ...
    def test_byteCodeGenerator_will_generate_code_for_while_loop_with_statements(self):
        ...
        self.assertEqual(self.byteCodeGenerator.storeRegister([5, 7, 12]),byteCodes[13])
