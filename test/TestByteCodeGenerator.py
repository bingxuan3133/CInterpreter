...
"""
    ...
    def test_generateByteCode_for_the_equation_that_contain_floating_point(self):
        ...
        self.byteCodeGenerator.initGeneration()
        byteCodes = token.generateByteCode()
        self.assertEqual(self.byteCodeGenerator.loadFloatingPoint([0]),byteCodes[0])
        self.assertEqual(self.byteCodeGenerator.immediateFloatingPoint([float1[0],float1[1],float1[2],float1[3]]),byteCodes[1])
        self.assertEqual(self.byteCodeGenerator.immediateFloatingPoint([float1[4],float1[5],float1[6],float1[7]]),byteCodes[2])
        self.assertEqual(self.byteCodeGenerator.loadFloatingPoint([5]),byteCodes[3])
        self.assertEqual(self.byteCodeGenerator.immediateFloatingPoint([float2[0],float2[1],float2[2],float2[3]]),byteCodes[4])
        self.assertEqual(self.byteCodeGenerator.immediateFloatingPoint([float2[4],float2[5],float2[6],float2[7]]),byteCodes[5])
        self.assertEqual(self.byteCodeGenerator.addFloatingRegister([0, 0, 5]),byteCodes[6])
