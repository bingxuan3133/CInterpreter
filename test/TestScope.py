...
class TestScope(unittest.TestCase):
    ...
    def test_findLocal(self):
        ...
        scope.buildScope(tokenLists[0])
        returnedToken = scope.findLocal('x')
        self.assertEqual(None, returnedToken)
        returnedToken = scope.findLocal('y')
        self.assertEqual(None, returnedToken)
    ...
    def test_findLocal_with_many_variable(self):
        ...
        scope.buildScope(tokenLists[0])
        returnedToken = scope.findLocal('a')
        self.assertEqual(None, returnedToken)
        returnedToken = scope.findLocal('b')
        self.assertEqual(None, returnedToken)
        returnedToken = scope.findLocal('x')
        self.assertEqual(None, returnedToken)
        returnedToken = scope.findLocal('y')
        self.assertEqual(None, returnedToken)
        returnedToken = scope.findLocal('z')
        self.assertEqual(None, returnedToken)
